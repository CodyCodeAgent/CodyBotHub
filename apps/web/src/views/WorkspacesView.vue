...
<template>
  <div class="page">
    <header class="page-header"><div><p class="eyebrow">Execution boundaries</p><h1>工作区</h1><p class="page-description">每个工作区对应一个本地目录，也是文件访问、Prompt 和 Codex 会话的运行边界。</p></div><button class="button" @click="edit()"><Plus :size="17" />创建工作区</button></header>
