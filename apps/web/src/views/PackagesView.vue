...
<template>
  <div class="page">
    <header class="page-header"><div><p class="eyebrow">Reusable capability sets</p><h1>技能包</h1><p class="page-description">把场景需要的 Skill、Prompt 和查找策略打包。技能包属于一个工作区，避免把目录专属能力注入到错误的会话。</p></div><button class="button" :disabled="!workspaces.length" @click="edit()"><Plus :size="17" />创建技能包</button></header>
