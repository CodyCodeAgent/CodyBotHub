...
.message-log-table td{overflow-wrap:anywhere}.message-log-table td:first-child,.duration-cell{white-space:nowrap}.bot-route-title{display:flex;align-items:center;flex-wrap:wrap;gap:6px;font-size:12px;font-weight:650;line-height:1.45}
</style>
