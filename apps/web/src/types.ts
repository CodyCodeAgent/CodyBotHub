...
export interface Tool { id: string; workspaceId: string; name: string; description: string; executorType: 'bits_rpc'|'command'; command: string; argumentsTemplate: string[]; inputSchema: Record<string, unknown>; timeoutSeconds: number; enabled: boolean; createdAt: string; updatedAt: string }
