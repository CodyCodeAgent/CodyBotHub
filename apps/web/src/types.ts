...
export interface Bot { id: string; name: string; description: string; appId: string; hasAppSecret: boolean; prompt: string; permissions: string[]; operatorIds: string[]; conversationMode: 'chat' | 'topic'; runtimeKind: AgentRuntimeKind; model: string; reasoningEffort: string; defaultWorkspaceId: string; workspaceIds: string[]; createdAt: string; updatedAt: string }
