...
export interface ThreadRoutingDecisionRecord { logId: string; messageId: string; sceneName: string; type: ThreadRoutingDecisionType; threadChannelId: string; coreThreadId: string; matchedThreadId: string; score: number; reason: string; receivedAt: string }
...
export interface SystemHealth {
  ...
  feishu: { configuredBots: number; activeProviders: number; connectedProviders: number; scheduledJobs: number; activeChannels: number; lastQueueScanAt: string; lastError: string; providers: Array<{ botId: string; botName: string; state: string; error: string }> }
